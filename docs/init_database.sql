...
CREATE TABLE IF NOT EXISTS `employees` (
    ...
    `deleted_flag` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'deleted_flag:0=active,1=deleted',
    `created_by` BIGINT UNSIGNED DEFAULT NULL COMMENT 'created_by',
    `updated_by` BIGINT UNSIGNED DEFAULT NULL COMMENT 'updated_by',    
...
CREATE TABLE IF NOT EXISTS `customer_tag_relations` (
    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `customer_id` BIGINT UNSIGNED NOT NULL COMMENT 'customer_id',
    `tag_id` BIGINT UNSIGNED NOT NULL COMMENT 'tag_id',
    `employee_id` BIGINT UNSIGNED DEFAULT NULL COMMENT 'employee_id',
